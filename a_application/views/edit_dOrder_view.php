...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				<li><a href="<?php echo base_url('admin.php/admin/dashboard'); ?>"><svg class="glyph stroked home"><use xlink:href="#stroked-home"></use></svg></a></li>
				...
				<div class="panel panel-primary">
				  ...
				  <div class="panel-body">
					...
					<?php foreach ($detail_dorder as $row){ ?>
							...
							<div class = 'col-md-12 col-xs-12 col-sm-12'>
								<div class = 'col-md-2'>
									<label for='lb_brgId' class='control-label'>Nama Barang</label>
								</div>
								
								<div class = 'col-md-10'>
									<label for='brgId' class='control-label'>
									<?php 
